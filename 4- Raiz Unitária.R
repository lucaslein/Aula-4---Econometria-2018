...
plot(Quantidade, main="Indice do Dia", xlab="Dias", col="blue")           #Grafico da Quantidade, com cores, legendas e eixo "x" especificados
                              ...
                              #Realizando teste DF-Dick-Fuller
...
Col4_Resultado <- c("", "Estacionaria","","Estacionaria", "Sem Drift","", 
                    "Estacionaria", "Sem Drift", "Sem Tendencia" )                 #Vetor da quarta Coluna
Resultado_Variacao <- cbind(Col1_Variacao,Col2_Variacao,Col3_Variacao,Col4_Resultado)    #Transformando os vetores em colunas
colnames(Resultado_Variacao) <- c("T Critico 1%", "Estatistica T","P-Value", "Resultado")   #Nomeando as colunas
rownames(Resultado_Variacao) <- c("SEM CONSTANTE E SEM TENDENCIA", 
                                  "Yt-1",
                                  "COM CONSTANTE",
                                  "Yt-1", "Drift",
                                  "COM CONSTANTE E COM TENDENCIA",
